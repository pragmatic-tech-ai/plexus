...
// PAINTS the title strip itself (the shell's Header region → the
// @PragmaticTitleBar view; the title text comes from TitleService). Two things
// stay outside mural because they're OS/DOM concerns:
...
// change it re-tints them to the header's surface (@Surface) / ink
