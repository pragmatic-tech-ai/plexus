...
// The producer-factory compile capability (compileToDocument → a base TodlDocument)
// lives app-side in services/projects/producer-project-factory.ts, not here: it
// references the todl compiler's TodlDocument type and core keeps a todl-runtime-
// only floor. `ProducerKind` above is the core-safe part the base-resolver needs.
