import { type IProjectFactory, type Project } from "@pragmatic-tech-ai/todl";
...
export class TodlPackageProjectFactory implements IProjectFactory
{
    ...
    readonly title = "TODL Package"
    readonly description = "A publishable TODL package (compiled model + sources)."
    readonly formats = []

    // The IProjectFactory contract types these as todl `Project`. A todl-package
    // member is a lightweight TodlPackageProject (name + storage) — the solution flow
